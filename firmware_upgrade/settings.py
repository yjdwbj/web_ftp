"""
Django settings for firmware_upgrade project.
...
SECRET_KEY = '1lg&+el+83@3^r-!64x*no%+iysc=2_)!ff1(jw_iyzr&=ym--'
...
WSGI_APPLICATION = 'firmware_upgrade.wsgi.application'
